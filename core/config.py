...
__C.YOLO.ORIGINAL_WEIGHT        = "/content/drive/MyDrive/Voc/checkpoint/yolov3_coco_demo.ckpt"
__C.YOLO.DEMO_WEIGHT            = "/content/drive/MyDrive/Voc/checkpoint/yolov3_coco_demo.ckpt"
...
__C.TRAIN.INITIAL_WEIGHT        = "/content/drive/MyDrive/Voc/checkpoint/yolov3_coco_demo.ckpt"
...
__C.TEST.ANNOT_PATH             = "/content/drive/MyDrive/Voc/VOC2007/data/dataset/voc_test.txt"
...
__C.TEST.WEIGHT_FILE            = "/content/drive/MyDrive/Voc/checkpoint/yolov3_coco_demo.ckpt"
