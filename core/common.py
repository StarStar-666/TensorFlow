...
def RFB_net(input_data ,trainable, name, stride=1,scale =0.1, activate=True, bn=True):
    ...
    with tf.variable_scope(name):
        ...
        conv_1 = convolutional(conv, (3, 3, 256, 256), trainable,'conv_1')

        conv_2 = convolutional(conv, (1, 3, 256, 256), trainable, 'conv_2')

        conv_3 = convolutional(conv, (3, 1, 256, 256), trainable, 'conv_3')

        conv_4 = convolutional(conv_2, (3, 1, 256, 256), trainable, 'conv_4')

        conv_1_1 = BasicSepConv(conv_2, (3 ,3 ,256 ,256), 3, trainable,'BasicSepConv_1')

        conv_2_1 = BasicSepConv(conv_3, (3, 3, 256, 256), 3, trainable, 'BasicSepConv_2')

        conv_3_1 = BasicSepConv(conv_4, (3,3,256,256), 5, trainable,'BasicSepConv_3')

        output = tf.concat([conv_1, conv_1_1, conv_2_1, conv_3_1], axis=3)
